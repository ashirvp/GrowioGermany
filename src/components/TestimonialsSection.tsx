    ...
    <section id="testimonials" className="relative py-24 bg-[#070514] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="relative rounded-3xl bg-gradient-to-b from-white/[0.06] to-white/[0.02] border border-white/10 p-8 sm:p-12 backdrop-blur-xl shadow-2xl overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <span className="px-3.5 py-1.5 rounded-full bg-[#2200EE] text-white text-xs font-bold shadow-[0_0_15px_#2200EE] flex items-center space-x-1.5">
                ...
                <div className="pt-6 border-t border-white/10 flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center space-x-4">
                    <img
                      src={current.avatar}
                      alt={current.name}
                      className="w-14 h-14 rounded-full object-cover border-2 border-[#2200EE]"
                    />
                    <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className="p-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 text-gray-300 hover:text-white transition-all"
                    ...
                    <button
                      ...
                      className="p-3 rounded-full bg-[#2200EE] hover:bg-[#1C00C8] text-white shadow-[0_0_15px_#2200EE] transition-all"
